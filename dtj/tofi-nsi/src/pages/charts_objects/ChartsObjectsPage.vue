        ...
        <div class="no-padding no-margin">
          ...
          <q-banner dense inline-actions class="bg-orange-1">
            ...
            <div style="font-size: 1.2em; font-weight: bold;">
              <q-avatar color="black" text-color="white" icon="assignment_turned_in"></q-avatar>
              {{ $t("charts_objects") }}
            </div>
          ...
          <div style="height: calc(100vh - 450px); width: 100%" class="no-scroll">
            <div
