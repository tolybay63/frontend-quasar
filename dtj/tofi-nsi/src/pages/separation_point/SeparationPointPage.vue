    ...
    >
      ...
      <template v-slot:top>
        <div style="font-size: 1.2em; font-weight: bold">
          <q-avatar color="black" text-color="white" icon="train">
          </q-avatar>
          {{ $t("separation_point") }}
        </div>
...
import UpdaterSeparationPoint from "pages/separation_point/UpdaterSeparationPoint.vue";

export default {
  name: "SeparationPointPage",
  data: function () {
    return {
      loading: false,
      cols: [],
  ...
  methods: {
    ...
    editRow(row, mode) {
      ...
      this.$q
        .dialog({
          component: UpdaterSeparationPoint,
          componentProps: {
            mode: mode,
            data: data,
            // ...
