<template>
  <q-banner :dense="dense" inline-actions class="bg-amber-1">
    ...
    <template v-slot:action>
      ...
      <q-btn
          v-if="hasTarget('mdl:mn_ds:reltyp:sel:char:prop:edit')"
          :dense="dense"
          icon="edit_note"
          color="secondary"
          class="q-ml-sm"
      ...
      <q-btn
          v-if="hasTarget('mdl:mn_ds:reltyp:sel:char:prop:upd')"
          :dense="dense"
          icon="edit"
          color="secondary"
          class="q-ml-sm"
...
export default {
  ...
  methods: {
    ...
    editRow(rec) {
      this.$q
          .dialog({
            component: UpdaterRelTypCharGrProp,
            componentProps: {
              dta: rec,
    ...
    editData() {
      this.$q
          .dialog({
            component: UpdaterRelTypCharGrPropUpd,
            componentProps: {
              relTypCharGr: this.relTypCharGr,
              lg: this.lang,
              dense: true,
    ...
    loadData(relTypCharGr) {
      //console.log("TypCharGrProp", relTypCharGr)
