...
export default {
  ...
  methods: {
    ...
    loadDimMultiPropItemFactor(dmpi) {
      this.loading = ref(true);
      api
          .post('', {
            method: "dimMultiProp/loadDimMultiPropItemFactor",
            params: [dmpi],
          })
          .then((response) => {
    ...
    editRow(mode) {
      ...
      this.$q
          .dialog({
            component: UpdateDimMultiPropItemFactor,
            componentProps: {
              data: data,
              mode: mode,
            },
          ...
          .onOk((data) => {
            this.selected = []
            this.loadDimMultiPropItemFactor(this.dimMultiPropItem);
    ...
    removeRow() {
      ...
      this.$q
          ...
          .onOk(() => {
            api
                .post('', {
                  method: "dimMultiProp/deleteDimMultiPropItemFactor",
                  params: [rec.id],
                })
                .then(
                    () => {
