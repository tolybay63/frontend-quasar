...
import UpdateDimMultiPropItemRelCls from "pages/multiprop/dim/UpdateDimMultiPropItemRelCls.vue";

export default {
  name: 'DimMultiPropItemRelCls',
  ...
  methods: {
    ...
    editRow(mode) {
      ...
      this.$q
          .dialog({
            component: UpdateDimMultiPropItemRelCls,
            componentProps: {
              data: data,
              mode: mode,
            },
          ...
          .onOk((data) => {
            this.selected = []
            this.loadDimMultiPropItemRelCls(this.dimMultiPropItem);
