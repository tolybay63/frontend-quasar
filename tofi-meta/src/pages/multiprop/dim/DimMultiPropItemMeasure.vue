...
import UpdateDimMultiPropItemMeasure from "pages/multiprop/dim/UpdateDimMultiPropItemMeasure.vue";

export default {
  name: 'DimMultiPropItemMeasure',
  ...
  methods: {
    ...
    loadDimMultiPropItemMeasure(dmpia) {
      this.loading = ref(true);
      api
          .post('', {
            method: "dimMultiProp/loadDimMultiPropItemMeasure",
            params: [dmpia],
          })
          .then((response) => {
    ...
    editRow(mode) {
      ...
      this.$q
          .dialog({
            component: UpdateDimMultiPropItemMeasure,
            componentProps: {
              data: data,
              mode: mode,
            },
          ...
          .onOk((data) => {
            this.selected = []
            this.loadDimMultiPropItemMeasure(this.dimMultiPropItem);
    ...
    removeRow() {
      ...
      this.$q
          ...
          .onOk(() => {
            api
                .post('', {
                  method: "dimMultiProp/deleteDimMultiPropItemMeasure",
                  params: [rec.id],
                })
                .then(
                    () => {
